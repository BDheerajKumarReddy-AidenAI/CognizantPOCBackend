"""Recreate enums as varchar

Revision ID: d0070420c6b4
Revises: 2cc3bdc9fadb
Create Date: 2025-11-25 12:11:37.996403
...
revision: str = 'd0070420c6b4'
down_revision: Union[str, Sequence[str], None] = '2cc3bdc9fadb'
...
def upgrade() -> None:
    ...
    op.alter_column('opportunities', 'location',
               existing_type=postgresql.ENUM('USA', 'UK', 'INDIA', name='location'),
               type_=sa.Enum('USA', 'UK', 'INDIA', name='location', native_enum=False, length=50),
               existing_nullable=False)
    op.alter_column('opportunities', 'stage',
               existing_type=postgresql.ENUM('LEAD', 'QUALIFIED', 'PROPOSAL', 'NEGOTIATION', 'WON', 'LOST', name='stage'),
               type_=sa.Enum('LEAD', 'QUALIFIED', 'PROPOSAL', 'NEGOTIATION', 'WON', 'LOST', name='stage', native_enum=False, length=50),
               existing_nullable=False)
    op.alter_column('users', 'role',
               existing_type=postgresql.ENUM('SALES', 'PRICING', name='userrole'),
               type_=sa.Enum('SALES', 'PRICING', name='userrole', native_enum=False, length=50),
               existing_nullable=False)
...
def downgrade() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    op.alter_column('users', 'role',
               existing_type=sa.Enum('SALES', 'PRICING', name='userrole', native_enum=False, length=50),
               type_=postgresql.ENUM('SALES', 'PRICING', name='userrole'),
               existing_nullable=False)
    op.alter_column('opportunities', 'stage',
               existing_type=sa.Enum('LEAD', 'QUALIFIED', 'PROPOSAL', 'NEGOTIATION', 'WON', 'LOST', name='stage', native_enum=False, length=50),
               type_=postgresql.ENUM('LEAD', 'QUALIFIED', 'PROPOSAL', 'NEGOTIATION', 'WON', 'LOST', name='stage'),
               existing_nullable=False)
    op.alter_column('opportunities', 'location',
               existing_type=sa.Enum('USA', 'UK', 'INDIA', name='location', native_enum=False, length=50),
               type_=postgresql.ENUM('USA', 'UK', 'INDIA', name='location'),
               existing_nullable=False)
